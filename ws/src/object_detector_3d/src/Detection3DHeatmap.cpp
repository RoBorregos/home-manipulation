...
class Detect3DPlace
{
    ...
    actionlib::SimpleActionServer<object_detector_3d::GetPlacePositionAction> as_; // TODO: Type of simple as
...
public:
        ...
        as_(nh_, "detect3d_place", boost::bind(&Detect3DPlace::handleActionServer, this, _1), false)
    {
        ...
        heatmap_client_ = nh_.serviceClient<frida_manipulation_interfaces::HeatmapPlace>("HeatmapPlace");
    ...
    void handleActionServer(const object_detector_3d::GetPlacePositionGoalConstPtr &goal)
    {
