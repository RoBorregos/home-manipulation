...
def pick_and_pour_client(object_pose,destination_pose,container_height,bowl_radius,bowl_height,tip_pick):
    ...
    resp = pick_and_pour_(object_pose,destination_pose,bowl_height,bowl_radius,container_height,tip_pick)
    print(resp.success)
    return resp.success
...
if __name__ == "__main__":
    ...
    # pick_and_pour_client(object_pose,destination_pose,container_height,bowl_radius,bowl_height,tip_pick)
############################################################################################################
